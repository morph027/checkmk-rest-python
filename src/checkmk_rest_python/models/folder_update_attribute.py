...
from ..models.folder_update_attribute_management_protocol import (
    FolderUpdateAttributeManagementProtocol,
)
from ..models.folder_update_attribute_tag_address_family import (
    FolderUpdateAttributeTagAddressFamily,
)
from ..models.folder_update_attribute_tag_agent import FolderUpdateAttributeTagAgent
from ..models.folder_update_attribute_tag_criticality import (
    FolderUpdateAttributeTagCriticality,
)
from ..models.folder_update_attribute_tag_networking import (
    FolderUpdateAttributeTagNetworking,
)
from ..models.folder_update_attribute_tag_piggyback import (
    FolderUpdateAttributeTagPiggyback,
)
from ..models.folder_update_attribute_tag_snmp_ds import FolderUpdateAttributeTagSnmpDs
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.folder_update_attribute_labels import FolderUpdateAttributeLabels
    from ..models.folder_update_attribute_management_ipmi_credentials_type_1_type_0 import (
        FolderUpdateAttributeManagementIpmiCredentialsType1Type0,
    )
    from ..models.folder_update_attribute_management_snmp_community_type_1_type_0 import (
...
T = TypeVar("T", bound="FolderUpdateAttribute")
...
class FolderUpdateAttribute:
    ...
    Attributes:
        ...
        tag_address_family (FolderUpdateAttributeTagAddressFamily | Unset): Choices:
             ...
             * `"no-ip"`: No IP
        tag_agent (FolderUpdateAttributeTagAgent | Unset): Choices:
        ...
        tag_snmp_ds (FolderUpdateAttributeTagSnmpDs | Unset): Choices:
        ...
        tag_piggyback (FolderUpdateAttributeTagPiggyback | Unset): By default, each host has a piggyback data
        ...
        tag_criticality (FolderUpdateAttributeTagCriticality | Unset): Choices:
        ...
        tag_networking (FolderUpdateAttributeTagNetworking | Unset): Choices:
        ...
        labels (FolderUpdateAttributeLabels | Unset): Labels allow you to flexibly group your hosts in order to refer to
        ...
        management_protocol (FolderUpdateAttributeManagementProtocol | Unset): The protocol used to connect to the
            management board.
        ...
        management_snmp_community (FolderUpdateAttributeManagementSnmpCommunityType1Type0 | None | SNMPCommunity |
            SNMPv3AuthNoPrivacy | SNMPv3AuthPrivacy | SNMPv3NoAuthNoPrivacy | Unset): SNMP credentials
        management_ipmi_credentials (FolderUpdateAttributeManagementIpmiCredentialsType1Type0 | IPMIParameters | None |
    ...
    tag_address_family: FolderUpdateAttributeTagAddressFamily | Unset = UNSET
    tag_agent: FolderUpdateAttributeTagAgent | Unset = UNSET
    tag_snmp_ds: FolderUpdateAttributeTagSnmpDs | Unset = UNSET
    snmp_community: (
        SNMPCommunity
        | SNMPv3AuthNoPrivacy
        | SNMPv3AuthPrivacy
    ...
    tag_piggyback: FolderUpdateAttributeTagPiggyback | Unset = UNSET
    tag_criticality: FolderUpdateAttributeTagCriticality | Unset = UNSET
    tag_networking: FolderUpdateAttributeTagNetworking | Unset = UNSET
    labels: FolderUpdateAttributeLabels | Unset = UNSET
    network_scan: NetworkScan | Unset = UNSET
    management_protocol: FolderUpdateAttributeManagementProtocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tag_address_family: FolderUpdateAttributeTagAddressFamily | Unset
        if isinstance(_tag_address_family, Unset):
            tag_address_family = UNSET
        else:
            tag_address_family = FolderUpdateAttributeTagAddressFamily(
                _tag_address_family
            )

        _tag_agent = d.pop("tag_agent", UNSET)
        tag_agent: FolderUpdateAttributeTagAgent | Unset
        if isinstance(_tag_agent, Unset):
            tag_agent = UNSET
        else:
            tag_agent = FolderUpdateAttributeTagAgent(_tag_agent)

        _tag_snmp_ds = d.pop("tag_snmp_ds", UNSET)
        tag_snmp_ds: FolderUpdateAttributeTagSnmpDs | Unset
        if isinstance(_tag_snmp_ds, Unset):
            tag_snmp_ds = UNSET
        else:
            tag_snmp_ds = FolderUpdateAttributeTagSnmpDs(_tag_snmp_ds)
        ...
        tag_piggyback: FolderUpdateAttributeTagPiggyback | Unset
        if isinstance(_tag_piggyback, Unset):
            tag_piggyback = UNSET
        else:
            tag_piggyback = FolderUpdateAttributeTagPiggyback(_tag_piggyback)

        _tag_criticality = d.pop("tag_criticality", UNSET)
        tag_criticality: FolderUpdateAttributeTagCriticality | Unset
        if isinstance(_tag_criticality, Unset):
            tag_criticality = UNSET
        else:
            tag_criticality = FolderUpdateAttributeTagCriticality(_tag_criticality)

        _tag_networking = d.pop("tag_networking", UNSET)
        tag_networking: FolderUpdateAttributeTagNetworking | Unset
        if isinstance(_tag_networking, Unset):
            tag_networking = UNSET
        else:
            tag_networking = FolderUpdateAttributeTagNetworking(_tag_networking)

        _labels = d.pop("labels", UNSET)
        labels: FolderUpdateAttributeLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = FolderUpdateAttributeLabels.from_dict(_labels)
        ...
        management_protocol: FolderUpdateAttributeManagementProtocol | Unset
        if isinstance(_management_protocol, Unset):
            management_protocol = UNSET
        else:
            management_protocol = FolderUpdateAttributeManagementProtocol(
        ...
        def _parse_management_snmp_community(
            ...
            try:
                ...
                management_snmp_community_type_1_type_0 = (
                    FolderUpdateAttributeManagementSnmpCommunityType1Type0.from_dict(
                        data
                    )
                )
        ...
        def _parse_management_ipmi_credentials(
            ...
            try:
                ...
                management_ipmi_credentials_type_1_type_0 = (
                    FolderUpdateAttributeManagementIpmiCredentialsType1Type0.from_dict(
                        data
                    )
                )
        ...
        folder_update_attribute.additional_properties = d
        return folder_update_attribute
