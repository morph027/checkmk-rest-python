...
T = TypeVar("T", bound="ServiceDowntimeAttributes")


@_attrs_define
class ServiceDowntimeAttributes:
    """
    Attributes:
        ...
        service_description (str): The service name if the downtime corresponds to a service, otherwise this field is
            not present. Example: CPU Load.
        is_service (Any | Unset): Service downtime entry Default: True. Example: True.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_downtime_attributes = cls(
            site_id=site_id,
            host_name=host_name,
            author=author,
            start_time=start_time,
        ...
        service_downtime_attributes.additional_properties = d
        return service_downtime_attributes
