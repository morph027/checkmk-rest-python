...
T = TypeVar("T", bound="UpdateContactGroupAttributes")


@_attrs_define
class UpdateContactGroupAttributes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_contact_group_attributes = cls(
            alias=alias,
            inventory_paths=inventory_paths,
        )

        update_contact_group_attributes.additional_properties = d
        return update_contact_group_attributes
