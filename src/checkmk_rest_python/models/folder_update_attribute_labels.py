...
T = TypeVar("T", bound="FolderUpdateAttributeLabels")


@_attrs_define
class FolderUpdateAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        folder_update_attribute_labels = cls()

        folder_update_attribute_labels.additional_properties = d
        return folder_update_attribute_labels
