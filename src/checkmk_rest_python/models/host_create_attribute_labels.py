...
T = TypeVar("T", bound="HostCreateAttributeLabels")


@_attrs_define
class HostCreateAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        host_create_attribute_labels = cls()

        host_create_attribute_labels.additional_properties = d
        return host_create_attribute_labels
