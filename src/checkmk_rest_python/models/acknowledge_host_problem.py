...
from ..models.acknowledge_host_problem_acknowledge_type import (
    AcknowledgeHostProblemAcknowledgeType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AcknowledgeHostProblem")


@_attrs_define
class AcknowledgeHostProblem:
    """
    Attributes:
        comment (str): Comment to be stored alongside the acknowledgement. Example: This was expected..
        acknowledge_type (AcknowledgeHostProblemAcknowledgeType): Select a specific host. Example: host.
    ...
    comment: str
    acknowledge_type: AcknowledgeHostProblemAcknowledgeType
    host_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acknowledge_host_problem.additional_properties = d
