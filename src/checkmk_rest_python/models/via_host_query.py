...
from ..models.via_host_query_acknowledge_type import ViaHostQueryAcknowledgeType
...
T = TypeVar("T", bound="ViaHostQuery")
...
class ViaHostQuery:
    """
    Attributes:
        acknowledge_type (ViaHostQueryAcknowledgeType): Select hosts with a query. Example: host_by_query.
        query (BinaryExpr | LogicalExpr | NotExpr):
    """

    acknowledge_type: ViaHostQueryAcknowledgeType
    query: BinaryExpr | LogicalExpr | NotExpr
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        acknowledge_type = ViaHostQueryAcknowledgeType(d.pop("acknowledge_type"))
        ...
        via_host_query.additional_properties = d
        return via_host_query
