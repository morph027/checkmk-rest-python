...
from ..models.via_service_query_acknowledge_type import ViaServiceQueryAcknowledgeType
...
T = TypeVar("T", bound="ViaServiceQuery")


@_attrs_define
class ViaServiceQuery:
    """
    Attributes:
        acknowledge_type (ViaServiceQueryAcknowledgeType): Select services with a query. Example: service_by_query.
        query (BinaryExpr | LogicalExpr | NotExpr):
    """

    acknowledge_type: ViaServiceQueryAcknowledgeType
    query: BinaryExpr | LogicalExpr | NotExpr
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        acknowledge_type = ViaServiceQueryAcknowledgeType(d.pop("acknowledge_type"))
        ...
        via_service_query = cls(
            acknowledge_type=acknowledge_type,
            query=query,
        )

        via_service_query.additional_properties = d
        return via_service_query
