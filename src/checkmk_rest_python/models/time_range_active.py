...
from ..models.time_range_active_day import TimeRangeActiveDay
...
T = TypeVar("T", bound="TimeRangeActive")


@_attrs_define
class TimeRangeActive:
    """
    Attributes:
        day (TimeRangeActiveDay | Unset): The day for which time ranges are to be specified. The 'all' option allows to
            specify time ranges for all days. Default: TimeRangeActiveDay.ALL.
        time_ranges (list[TimeRange1] | Unset):  Example: [{'start': '13:00:00', 'end': '19:00:00'}].
    """

    day: TimeRangeActiveDay | Unset = TimeRangeActiveDay.ALL
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        day: TimeRangeActiveDay | Unset
        if isinstance(_day, Unset):
            day = UNSET
        else:
            day = TimeRangeActiveDay(_day)
        ...
        time_range_active = cls(
            day=day,
            time_ranges=time_ranges,
        )

        time_range_active.additional_properties = d
        return time_range_active
