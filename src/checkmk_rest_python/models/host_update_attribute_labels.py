...
T = TypeVar("T", bound="HostUpdateAttributeLabels")


@_attrs_define
class HostUpdateAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        host_update_attribute_labels = cls()

        host_update_attribute_labels.additional_properties = d
        return host_update_attribute_labels
