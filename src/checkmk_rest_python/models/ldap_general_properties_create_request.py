...
from ..models.ldap_general_properties_create_request_rule_activation import (
    LDAPGeneralPropertiesCreateRequestRuleActivation,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LDAPGeneralPropertiesCreateRequest")


@_attrs_define
class LDAPGeneralPropertiesCreateRequest:
    """
    Attributes:
        ...
        rule_activation (LDAPGeneralPropertiesCreateRequestRuleActivation | Unset): Selecting 'deactivated' will disable
            the rule, but it will remain in the configuration. Default:
            LDAPGeneralPropertiesCreateRequestRuleActivation.ACTIVATED.
    """
    ...
    rule_activation: LDAPGeneralPropertiesCreateRequestRuleActivation | Unset = (
        LDAPGeneralPropertiesCreateRequestRuleActivation.ACTIVATED
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_rule_activation, Unset):
            ...
            rule_activation = LDAPGeneralPropertiesCreateRequestRuleActivation(
                _rule_activation
            )

        ldap_general_properties_create_request = cls(
            id=id,
        ...
        ldap_general_properties_create_request.additional_properties = d
        return ldap_general_properties_create_request
