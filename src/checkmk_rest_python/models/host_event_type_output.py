...
T = TypeVar("T", bound="HostEventTypeOutput")


@_attrs_define
class HostEventTypeOutput:
    """
    Attributes:
        ...
        up_down (bool | Unset):  Example: True.
        up_unreachable (bool | Unset):
        down_up (bool | Unset):  Example: True.
        down_unreachable (bool | Unset):
        unreachable_down (bool | Unset):
        unreachable_up (bool | Unset):
        any_up (bool | Unset):
        any_down (bool | Unset):  Example: True.
        any_unreachable (bool | Unset):  Example: True.
    """
    ...
    up_down: bool | Unset = UNSET
    up_unreachable: bool | Unset = UNSET
    down_up: bool | Unset = UNSET
    down_unreachable: bool | Unset = UNSET
    unreachable_down: bool | Unset = UNSET
    unreachable_up: bool | Unset = UNSET
    any_up: bool | Unset = UNSET
    any_down: bool | Unset = UNSET
    any_unreachable: bool | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host_event_type_output.additional_properties = d
        return host_event_type_output
