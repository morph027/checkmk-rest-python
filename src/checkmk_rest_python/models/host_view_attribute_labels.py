...
T = TypeVar("T", bound="HostViewAttributeLabels")


@_attrs_define
class HostViewAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        host_view_attribute_labels = cls()

        host_view_attribute_labels.additional_properties = d
        return host_view_attribute_labels
