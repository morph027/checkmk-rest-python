...
if TYPE_CHECKING:
    from ..models.basic_settings_attributes_create import BasicSettingsAttributesCreate
...
T = TypeVar("T", bound="SiteConfigAttributesCreate")


@_attrs_define
class SiteConfigAttributesCreate:
    """
    Attributes:
        status_connection (StatusConnectionAttributes):
        configuration_connection (ConfigurationConnectionWithoutReplicationAttributes |
            ConfigurationConnectionWithReplicationAttributes):
        basic_settings (BasicSettingsAttributesCreate):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.basic_settings_attributes_create import (
        ...
        basic_settings = BasicSettingsAttributesCreate.from_dict(
            d.pop("basic_settings")
        )

        site_config_attributes_create = cls(
            status_connection=status_connection,
            configuration_connection=configuration_connection,
            basic_settings=basic_settings,
        )

        site_config_attributes_create.additional_properties = d
        return site_config_attributes_create
