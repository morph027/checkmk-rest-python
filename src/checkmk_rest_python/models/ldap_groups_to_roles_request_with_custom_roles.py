...
if TYPE_CHECKING:
    from ..models.ldap_role_element_request import LDAPRoleElementRequest


T = TypeVar("T", bound="LDAPGroupsToRolesRequestWithCustomRoles")


@_attrs_define
class LDAPGroupsToRolesRequestWithCustomRoles:
    """
    Attributes:
        ...
        handle_nested (bool | Unset): Once you enable this option, this plug-in will not only handle direct group
            ...
            Default: False.
        admin (list[LDAPRoleElementRequest] | Unset):
        agent_registration (list[LDAPRoleElementRequest] | Unset):
        guest (list[LDAPRoleElementRequest] | Unset):
        user (list[LDAPRoleElementRequest] | Unset):
        no_permissions (list[LDAPRoleElementRequest] | Unset):
    """

    state: Any = "enabled"
    handle_nested: bool | Unset = False
    admin: list[LDAPRoleElementRequest] | Unset = UNSET
    agent_registration: list[LDAPRoleElementRequest] | Unset = UNSET
    guest: list[LDAPRoleElementRequest] | Unset = UNSET
    user: list[LDAPRoleElementRequest] | Unset = UNSET
    no_permissions: list[LDAPRoleElementRequest] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _admin is not UNSET:
            ...
            for admin_item_data in _admin:
                admin_item = LDAPRoleElementRequest.from_dict(admin_item_data)
        ...
        if _agent_registration is not UNSET:
            ...
            for agent_registration_item_data in _agent_registration:
                agent_registration_item = LDAPRoleElementRequest.from_dict(
        ...
        if _guest is not UNSET:
            ...
            for guest_item_data in _guest:
                guest_item = LDAPRoleElementRequest.from_dict(guest_item_data)
        ...
        if _user is not UNSET:
            ...
            for user_item_data in _user:
                user_item = LDAPRoleElementRequest.from_dict(user_item_data)
        ...
        if _no_permissions is not UNSET:
            ...
            for no_permissions_item_data in _no_permissions:
                no_permissions_item = LDAPRoleElementRequest.from_dict(
                    no_permissions_item_data
                )

                no_permissions.append(no_permissions_item)

        ldap_groups_to_roles_request_with_custom_roles = cls(
            state=state,
        ...
        ldap_groups_to_roles_request_with_custom_roles.additional_properties = d
        return ldap_groups_to_roles_request_with_custom_roles
