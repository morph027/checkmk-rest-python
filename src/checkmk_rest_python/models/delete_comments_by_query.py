...
from ..models.delete_comments_by_query_delete_type import (
...
T = TypeVar("T", bound="DeleteCommentsByQuery")


@_attrs_define
class DeleteCommentsByQuery:
    """
    Attributes:
        delete_type (DeleteCommentsByQueryDeleteType): How you would like to delete comments. Example: delete_by_query.
        query (BinaryExpr | LogicalExpr | NotExpr | Unset):
    """

    delete_type: DeleteCommentsByQueryDeleteType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        delete_type = DeleteCommentsByQueryDeleteType(d.pop("delete_type"))
        ...
        delete_comments_by_query = cls(
            delete_type=delete_type,
            query=query,
        )

        delete_comments_by_query.additional_properties = d
        return delete_comments_by_query
