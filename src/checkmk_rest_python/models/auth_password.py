...
from ..models.auth_password_auth_type import AuthPasswordAuthType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AuthPassword")
...
class AuthPassword:
    """
    Attributes:
        auth_type (AuthPasswordAuthType | Unset): The authentication type Example: password.
        ...
        enforce_password_change (bool | Unset): If set to True, the user will be forced to change his password on the
            next login or access. Defaults to False Default: False.
    """

    auth_type: AuthPasswordAuthType | Unset = UNSET
    password: str | Unset = UNSET
    enforce_password_change: bool | Unset = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_type: AuthPasswordAuthType | Unset
        if isinstance(_auth_type, Unset):
            auth_type = UNSET
        else:
            auth_type = AuthPasswordAuthType(_auth_type)
        ...
        auth_password.additional_properties = d
