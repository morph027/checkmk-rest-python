...
T = TypeVar("T", bound="LDAPSyncPluginGroupAllOthersRequest")


@_attrs_define
class LDAPSyncPluginGroupAllOthersRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ldap_sync_plugin_group_all_others_request = cls(
            group_cn=group_cn,
            attribute_to_set=attribute_to_set,
            value=value,
        )

        ldap_sync_plugin_group_all_others_request.additional_properties = d
        return ldap_sync_plugin_group_all_others_request
