...
T = TypeVar("T", bound="LDAPConnectionSuffixUpdateRequest")


@_attrs_define
class LDAPConnectionSuffixUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ldap_connection_suffix_update_request = cls(
            state=state,
            suffix=suffix,
        )

        ldap_connection_suffix_update_request.additional_properties = d
        return ldap_connection_suffix_update_request
