...
T = TypeVar("T", bound="QuickSetupFinalActionRequest")


@_attrs_define
class QuickSetupFinalActionRequest:
    """
    Attributes:
        button_id (str): Unique id of the action button clicked by the user Example: save.
        stages (list[QuickSetupStageRequest] | Unset): A list of stages' form data Example: [{'stage_data': []},
            {'stage_data': []}].
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_setup_final_action_request = cls(
            button_id=button_id,
            stages=stages,
        )

        quick_setup_final_action_request.additional_properties = d
        return quick_setup_final_action_request
