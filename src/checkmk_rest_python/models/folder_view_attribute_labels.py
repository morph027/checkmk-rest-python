...
T = TypeVar("T", bound="FolderViewAttributeLabels")


@_attrs_define
class FolderViewAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        folder_view_attribute_labels = cls()

        folder_view_attribute_labels.additional_properties = d
        return folder_view_attribute_labels
