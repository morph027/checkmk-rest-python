...
from ..models.notification_bulking_time_period_notification_bulks_based_on_item import (
...
if TYPE_CHECKING:
    ...
    from ..models.outside_timeperiod_value import OutsideTimeperiodValue


T = TypeVar("T", bound="NotificationBulkingTimePeriod")


@_attrs_define
class NotificationBulkingTimePeriod:
    """
    Attributes:
        ...
        notification_bulks_based_on (list[NotificationBulkingTimePeriodNotificationBulksBasedOnItem]):
        time_period (str):  Example: 24X7.
        bulk_outside_timeperiod (Checkbox | OutsideTimeperiodValue):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        bulk_outside_timeperiod: dict[str, Any]
        if isinstance(self.bulk_outside_timeperiod, Checkbox):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bulk_outside_timeperiod(
            data: object,
        ) -> Checkbox | OutsideTimeperiodValue:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_time_period_one_of_type_0 = Checkbox.from_dict(data)

                return componentsschemas_time_period_one_of_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_time_period_one_of_type_1 = (
                OutsideTimeperiodValue.from_dict(data)
            )

            return componentsschemas_time_period_one_of_type_1

        bulk_outside_timeperiod = _parse_bulk_outside_timeperiod(
            d.pop("bulk_outside_timeperiod")
        )
        ...
        notification_bulking_time_period = cls(
            subject_for_bulk_notifications=subject_for_bulk_notifications,
            max_bulk_size=max_bulk_size,
            notification_bulks_based_on=notification_bulks_based_on,
            time_period=time_period,
        ...
        notification_bulking_time_period.additional_properties = d
        return notification_bulking_time_period
