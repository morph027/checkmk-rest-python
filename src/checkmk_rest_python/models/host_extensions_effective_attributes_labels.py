...
T = TypeVar("T", bound="HostExtensionsEffectiveAttributesLabels")


@_attrs_define
class HostExtensionsEffectiveAttributesLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        host_extensions_effective_attributes_labels = cls()

        host_extensions_effective_attributes_labels.additional_properties = d
        return host_extensions_effective_attributes_labels
