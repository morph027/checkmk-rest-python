...
from ..models.modify_downtime_by_host_group_modify_type import (
...
T = TypeVar("T", bound="ModifyDowntimeByHostGroup")


@_attrs_define
class ModifyDowntimeByHostGroup:
    """
    Attributes:
        modify_type (ModifyDowntimeByHostGroupModifyType): The option of how to select the downtimes to be targeted by
            the modification. Example: params.
        hostgroup_name (str): Name of a valid hostgroup, all current downtimes for hosts in this group will be modified.
            Example: windows.
    ...
    modify_type: ModifyDowntimeByHostGroupModifyType
    hostgroup_name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        modify_type = ModifyDowntimeByHostGroupModifyType(d.pop("modify_type"))
        ...
        modify_downtime_by_host_group = cls(
            modify_type=modify_type,
            hostgroup_name=hostgroup_name,
            end_time=end_time,
            comment=comment,
        ...
        modify_downtime_by_host_group.additional_properties = d
        return modify_downtime_by_host_group
