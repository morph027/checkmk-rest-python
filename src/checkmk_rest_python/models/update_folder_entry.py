...
if TYPE_CHECKING:
    ...
    from ..models.folder_update_attribute import FolderUpdateAttribute
    from ..models.tag_group_attributes import TagGroupAttributes


T = TypeVar("T", bound="UpdateFolderEntry")


@_attrs_define
class UpdateFolderEntry:
    r"""
    Attributes:
        ...
        title (str | Unset): The title of the folder. Used in the GUI. Example: Virtual Servers..
        attributes (CustomHostAttributes | FolderUpdateAttribute | TagGroupAttributes | Unset): Replace all attributes
            with the ones given in this field. Already setattributes, not given here, will be removed. Can't be used
            together with update_attributes or remove_attributes fields. Example: {'tag_networking': 'wan'}.
        update_attributes (CustomHostAttributes | FolderUpdateAttribute | TagGroupAttributes | Unset): Just update the
            folder attributes with these attributes. The previously set attributes will be overwritten. Can't be used
            together with attributes or remove_attributes fields. Example: {'tag_criticality': 'prod'}.
        remove_attributes (list[str] | Unset): A list of attributes which should be removed. Can't be used together with
            attributes or update_attributes fields. Example: ['tag_foobar'].
    """

    folder: str
    title: str | Unset = UNSET
    attributes: (
        CustomHostAttributes | FolderUpdateAttribute | TagGroupAttributes | Unset
    ) = UNSET
    update_attributes: (
        CustomHostAttributes | FolderUpdateAttribute | TagGroupAttributes | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.attributes, Unset):
            attributes = UNSET
        elif isinstance(self.attributes, FolderUpdateAttribute):
        ...
        elif isinstance(self.update_attributes, FolderUpdateAttribute):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_attributes(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                attributes_type_0 = FolderUpdateAttribute.from_dict(data)
        ...
        def _parse_update_attributes(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                update_attributes_type_0 = FolderUpdateAttribute.from_dict(data)
        ...
        update_folder_entry.additional_properties = d
        return update_folder_entry
