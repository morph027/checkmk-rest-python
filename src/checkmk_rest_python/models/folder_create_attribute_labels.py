...
T = TypeVar("T", bound="FolderCreateAttributeLabels")


@_attrs_define
class FolderCreateAttributeLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        folder_create_attribute_labels = cls()

        folder_create_attribute_labels.additional_properties = d
        return folder_create_attribute_labels
