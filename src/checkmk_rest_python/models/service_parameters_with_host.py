...
T = TypeVar("T", bound="ServiceParametersWithHost")


@_attrs_define
class ServiceParametersWithHost:
    """
    Attributes:
        ...
        host_name (str | Unset): A host name. Example: example.com.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_parameters_with_host = cls(
            sites=sites,
            columns=columns,
            query=query,
            host_name=host_name,
        ...
        service_parameters_with_host.additional_properties = d
        return service_parameters_with_host
