...
from ..models.host_create_attribute_management_protocol import (
    HostCreateAttributeManagementProtocol,
)
from ..models.host_create_attribute_tag_address_family import (
    HostCreateAttributeTagAddressFamily,
)
from ..models.host_create_attribute_tag_agent import HostCreateAttributeTagAgent
from ..models.host_create_attribute_tag_criticality import (
    HostCreateAttributeTagCriticality,
)
from ..models.host_create_attribute_tag_networking import (
    HostCreateAttributeTagNetworking,
)
from ..models.host_create_attribute_tag_piggyback import HostCreateAttributeTagPiggyback
from ..models.host_create_attribute_tag_snmp_ds import HostCreateAttributeTagSnmpDs
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.host_contact_group import HostContactGroup
    from ..models.host_create_attribute_labels import HostCreateAttributeLabels
    from ..models.host_create_attribute_management_ipmi_credentials_type_1_type_0 import (
        HostCreateAttributeManagementIpmiCredentialsType1Type0,
    )
    from ..models.host_create_attribute_management_snmp_community_type_1_type_0 import (
...
T = TypeVar("T", bound="HostCreateAttribute")


@_attrs_define
class HostCreateAttribute:
    """
    Attributes:
        ...
        tag_address_family (HostCreateAttributeTagAddressFamily | Unset): Choices:
        ...
        tag_agent (HostCreateAttributeTagAgent | Unset): Choices:
        ...
        tag_snmp_ds (HostCreateAttributeTagSnmpDs | Unset): Choices:
        ...
        tag_piggyback (HostCreateAttributeTagPiggyback | Unset): By default, each host has a piggyback data
        ...
        tag_criticality (HostCreateAttributeTagCriticality | Unset): Choices:
        ...
        tag_networking (HostCreateAttributeTagNetworking | Unset): Choices:
        ...
        labels (HostCreateAttributeLabels | Unset): Labels allow you to flexibly group your hosts in order to refer to
        ...
        management_protocol (HostCreateAttributeManagementProtocol | Unset): The protocol used to connect to the
            management board.
        ...
        management_address (str | Unset): Address (IPv4, IPv6 or host name) under which the management board can be
            reached.
        management_snmp_community (HostCreateAttributeManagementSnmpCommunityType1Type0 | None | SNMPCommunity |
            SNMPv3AuthNoPrivacy | SNMPv3AuthPrivacy | SNMPv3NoAuthNoPrivacy | Unset): SNMP credentials
        management_ipmi_credentials (HostCreateAttributeManagementIpmiCredentialsType1Type0 | IPMIParameters | None |
    ...
    tag_address_family: HostCreateAttributeTagAddressFamily | Unset = UNSET
    ...
    tag_agent: HostCreateAttributeTagAgent | Unset = UNSET
    tag_snmp_ds: HostCreateAttributeTagSnmpDs | Unset = UNSET
    snmp_community: (
        SNMPCommunity
        | SNMPv3AuthNoPrivacy
        | SNMPv3AuthPrivacy
    ...
    tag_piggyback: HostCreateAttributeTagPiggyback | Unset = UNSET
    tag_criticality: HostCreateAttributeTagCriticality | Unset = UNSET
    tag_networking: HostCreateAttributeTagNetworking | Unset = UNSET
    labels: HostCreateAttributeLabels | Unset = UNSET
    waiting_for_discovery: bool | Unset = UNSET
    network_scan: NetworkScan | Unset = UNSET
    management_protocol: HostCreateAttributeManagementProtocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tag_address_family: HostCreateAttributeTagAddressFamily | Unset
        if isinstance(_tag_address_family, Unset):
            tag_address_family = UNSET
        else:
            tag_address_family = HostCreateAttributeTagAddressFamily(
                _tag_address_family
            )
        ...
        tag_agent: HostCreateAttributeTagAgent | Unset
        if isinstance(_tag_agent, Unset):
            tag_agent = UNSET
        else:
            tag_agent = HostCreateAttributeTagAgent(_tag_agent)

        _tag_snmp_ds = d.pop("tag_snmp_ds", UNSET)
        tag_snmp_ds: HostCreateAttributeTagSnmpDs | Unset
        if isinstance(_tag_snmp_ds, Unset):
            tag_snmp_ds = UNSET
        else:
            tag_snmp_ds = HostCreateAttributeTagSnmpDs(_tag_snmp_ds)
        ...
        tag_piggyback: HostCreateAttributeTagPiggyback | Unset
        if isinstance(_tag_piggyback, Unset):
            tag_piggyback = UNSET
        else:
            tag_piggyback = HostCreateAttributeTagPiggyback(_tag_piggyback)

        _tag_criticality = d.pop("tag_criticality", UNSET)
        tag_criticality: HostCreateAttributeTagCriticality | Unset
        if isinstance(_tag_criticality, Unset):
            tag_criticality = UNSET
        else:
            tag_criticality = HostCreateAttributeTagCriticality(_tag_criticality)

        _tag_networking = d.pop("tag_networking", UNSET)
        tag_networking: HostCreateAttributeTagNetworking | Unset
        if isinstance(_tag_networking, Unset):
            tag_networking = UNSET
        else:
            tag_networking = HostCreateAttributeTagNetworking(_tag_networking)

        _labels = d.pop("labels", UNSET)
        labels: HostCreateAttributeLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = HostCreateAttributeLabels.from_dict(_labels)
        ...
        management_protocol: HostCreateAttributeManagementProtocol | Unset
        if isinstance(_management_protocol, Unset):
            management_protocol = UNSET
        else:
            management_protocol = HostCreateAttributeManagementProtocol(
        ...
        def _parse_management_snmp_community(
            ...
            try:
                ...
                management_snmp_community_type_1_type_0 = (
                    HostCreateAttributeManagementSnmpCommunityType1Type0.from_dict(data)
                )
        ...
        def _parse_management_ipmi_credentials(
            ...
            try:
                ...
                management_ipmi_credentials_type_1_type_0 = (
                    HostCreateAttributeManagementIpmiCredentialsType1Type0.from_dict(
                        data
                    )
                )
        ...
        host_create_attribute.additional_properties = d
        return host_create_attribute
