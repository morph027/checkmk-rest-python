...
from ..models.acknowledge_service_group_problem_acknowledge_type import (
    AcknowledgeServiceGroupProblemAcknowledgeType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AcknowledgeServiceGroupProblem")


@_attrs_define
class AcknowledgeServiceGroupProblem:
    """
    Attributes:
        comment (str): Comment to be stored alongside the acknowledgement. Example: This was expected..
        acknowledge_type (AcknowledgeServiceGroupProblemAcknowledgeType): Select all services in a service group.
    ...
    comment: str
    acknowledge_type: AcknowledgeServiceGroupProblemAcknowledgeType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acknowledge_service_group_problem = cls(
            comment=comment,
            acknowledge_type=acknowledge_type,
            servicegroup_name=servicegroup_name,
            sticky=sticky,
        ...
        acknowledge_service_group_problem.additional_properties = d
        return acknowledge_service_group_problem
