...
if TYPE_CHECKING:
    ...
    from ..models.host_conditions_host_tags import HostConditionsHostTags
    from ..models.label_group_condition import LabelGroupCondition


T = TypeVar("T", bound="HostConditions")
...
class HostConditions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host_tags = HostConditionsHostTags.from_dict(d.pop("host_tags"))
        ...
        host_conditions.additional_properties = d
