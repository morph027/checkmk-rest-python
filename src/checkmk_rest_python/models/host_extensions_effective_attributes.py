...
from ..models.host_extensions_effective_attributes_management_protocol import (
...
if TYPE_CHECKING:
    ...
    from ..models.host_extensions_effective_attributes_labels import (
        HostExtensionsEffectiveAttributesLabels,
    )
    from ..models.host_extensions_effective_attributes_management_ipmi_credentials_type_1_type_0 import (
        HostExtensionsEffectiveAttributesManagementIpmiCredentialsType1Type0,
    )
    from ..models.host_extensions_effective_attributes_management_snmp_community_type_1_type_0 import (
...
T = TypeVar("T", bound="HostExtensionsEffectiveAttributes")


@_attrs_define
class HostExtensionsEffectiveAttributes:
    """
    Attributes:
        ...
        labels (HostExtensionsEffectiveAttributesLabels | Unset): Labels allow you to flexibly group your hosts in order
            to refer to them later at other places in Checkmk, e.g. in rule chains.<br><b>Label format:</b>
            key:value<br><br>Neither the key nor the value can contain ‘:’. Checkmk does not perform any other validation on
            the labels you use.
        ...
        management_protocol (HostExtensionsEffectiveAttributesManagementProtocol | Unset): The protocol used to connect
        ...
        management_address (str | Unset): Address (IPv4, IPv6 or host name) under which the management board can be
            reached.
        management_snmp_community (HostExtensionsEffectiveAttributesManagementSnmpCommunityType1Type0 | None |
            SNMPCommunity | SNMPv3AuthNoPrivacy | SNMPv3AuthPrivacy | SNMPv3NoAuthNoPrivacy | Unset): SNMP credentials
        management_ipmi_credentials (HostExtensionsEffectiveAttributesManagementIpmiCredentialsType1Type0 |
            IPMIParameters | None | Unset): IPMI credentials
    ...
    labels: HostExtensionsEffectiveAttributesLabels | Unset = UNSET
    ...
    management_protocol: HostExtensionsEffectiveAttributesManagementProtocol | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        labels: HostExtensionsEffectiveAttributesLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = HostExtensionsEffectiveAttributesLabels.from_dict(_labels)
        ...
        if isinstance(_management_protocol, Unset):
            ...
            management_protocol = HostExtensionsEffectiveAttributesManagementProtocol(
        ...
        def _parse_management_snmp_community(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                management_snmp_community_type_1_type_0 = HostExtensionsEffectiveAttributesManagementSnmpCommunityType1Type0.from_dict(
                    data
                )
        ...
        def _parse_management_ipmi_credentials(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                management_ipmi_credentials_type_1_type_0 = HostExtensionsEffectiveAttributesManagementIpmiCredentialsType1Type0.from_dict(
                    data
                )
        ...
        host_extensions_effective_attributes = cls(
            alias=alias,
            site=site,
        ...
        host_extensions_effective_attributes.additional_properties = d
        return host_extensions_effective_attributes
