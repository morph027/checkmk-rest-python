...
from ..models.cluster_create_attribute_management_protocol import (
    ClusterCreateAttributeManagementProtocol,
)
from ..models.cluster_create_attribute_tag_address_family import (
    ClusterCreateAttributeTagAddressFamily,
)
from ..models.cluster_create_attribute_tag_agent import ClusterCreateAttributeTagAgent
from ..models.cluster_create_attribute_tag_criticality import (
    ClusterCreateAttributeTagCriticality,
)
from ..models.cluster_create_attribute_tag_networking import (
    ClusterCreateAttributeTagNetworking,
)
from ..models.cluster_create_attribute_tag_piggyback import (
    ClusterCreateAttributeTagPiggyback,
)
from ..models.cluster_create_attribute_tag_snmp_ds import (
    ClusterCreateAttributeTagSnmpDs,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.cluster_create_attribute_labels import ClusterCreateAttributeLabels
    from ..models.cluster_create_attribute_management_ipmi_credentials_type_1_type_0 import (
        ClusterCreateAttributeManagementIpmiCredentialsType1Type0,
    )
    from ..models.cluster_create_attribute_management_snmp_community_type_1_type_0 import (
...
T = TypeVar("T", bound="ClusterCreateAttribute")


@_attrs_define
class ClusterCreateAttribute:
    """
    Attributes:
        ...
        tag_address_family (ClusterCreateAttributeTagAddressFamily | Unset): Choices:
        ...
        tag_agent (ClusterCreateAttributeTagAgent | Unset): Choices:
        ...
        tag_snmp_ds (ClusterCreateAttributeTagSnmpDs | Unset): Choices:
        ...
        tag_piggyback (ClusterCreateAttributeTagPiggyback | Unset): By default, each host has a piggyback data
        ...
        tag_criticality (ClusterCreateAttributeTagCriticality | Unset): Choices:
        ...
        tag_networking (ClusterCreateAttributeTagNetworking | Unset): Choices:
        ...
        labels (ClusterCreateAttributeLabels | Unset): Labels allow you to flexibly group your hosts in order to refer
            to them later at other places in Checkmk, e.g. in rule chains.<br><b>Label format:</b> key:value<br><br>Neither
            the key nor the value can contain ‘:’. Checkmk does not perform any other validation on the labels you use.
        ...
        management_protocol (ClusterCreateAttributeManagementProtocol | Unset): The protocol used to connect to the
            management board.
        ...
        management_address (str | Unset): Address (IPv4, IPv6 or host name) under which the management board can be
            reached.
        management_snmp_community (ClusterCreateAttributeManagementSnmpCommunityType1Type0 | None | SNMPCommunity |
            SNMPv3AuthNoPrivacy | SNMPv3AuthPrivacy | SNMPv3NoAuthNoPrivacy | Unset): SNMP credentials
        management_ipmi_credentials (ClusterCreateAttributeManagementIpmiCredentialsType1Type0 | IPMIParameters | None |
    ...
    tag_address_family: ClusterCreateAttributeTagAddressFamily | Unset = UNSET
    ...
    tag_agent: ClusterCreateAttributeTagAgent | Unset = UNSET
    tag_snmp_ds: ClusterCreateAttributeTagSnmpDs | Unset = UNSET
    snmp_community: (
        SNMPCommunity
        | SNMPv3AuthNoPrivacy
        | SNMPv3AuthPrivacy
    ...
    tag_piggyback: ClusterCreateAttributeTagPiggyback | Unset = UNSET
    tag_criticality: ClusterCreateAttributeTagCriticality | Unset = UNSET
    tag_networking: ClusterCreateAttributeTagNetworking | Unset = UNSET
    labels: ClusterCreateAttributeLabels | Unset = UNSET
    waiting_for_discovery: bool | Unset = UNSET
    network_scan: NetworkScan | Unset = UNSET
    management_protocol: ClusterCreateAttributeManagementProtocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.cluster_create_attribute_labels import (
        ...
        tag_address_family: ClusterCreateAttributeTagAddressFamily | Unset
        if isinstance(_tag_address_family, Unset):
            tag_address_family = UNSET
        else:
            tag_address_family = ClusterCreateAttributeTagAddressFamily(
                _tag_address_family
            )
        ...
        tag_agent: ClusterCreateAttributeTagAgent | Unset
        if isinstance(_tag_agent, Unset):
            tag_agent = UNSET
        else:
            tag_agent = ClusterCreateAttributeTagAgent(_tag_agent)

        _tag_snmp_ds = d.pop("tag_snmp_ds", UNSET)
        tag_snmp_ds: ClusterCreateAttributeTagSnmpDs | Unset
        if isinstance(_tag_snmp_ds, Unset):
            tag_snmp_ds = UNSET
        else:
            tag_snmp_ds = ClusterCreateAttributeTagSnmpDs(_tag_snmp_ds)
        ...
        tag_piggyback: ClusterCreateAttributeTagPiggyback | Unset
        if isinstance(_tag_piggyback, Unset):
            tag_piggyback = UNSET
        else:
            tag_piggyback = ClusterCreateAttributeTagPiggyback(_tag_piggyback)

        _tag_criticality = d.pop("tag_criticality", UNSET)
        tag_criticality: ClusterCreateAttributeTagCriticality | Unset
        if isinstance(_tag_criticality, Unset):
            tag_criticality = UNSET
        else:
            tag_criticality = ClusterCreateAttributeTagCriticality(_tag_criticality)

        _tag_networking = d.pop("tag_networking", UNSET)
        tag_networking: ClusterCreateAttributeTagNetworking | Unset
        if isinstance(_tag_networking, Unset):
            tag_networking = UNSET
        else:
            tag_networking = ClusterCreateAttributeTagNetworking(_tag_networking)

        _labels = d.pop("labels", UNSET)
        labels: ClusterCreateAttributeLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = ClusterCreateAttributeLabels.from_dict(_labels)
        ...
        management_protocol: ClusterCreateAttributeManagementProtocol | Unset
        if isinstance(_management_protocol, Unset):
            management_protocol = UNSET
        else:
            management_protocol = ClusterCreateAttributeManagementProtocol(
        ...
        def _parse_management_snmp_community(
            ...
            try:
                ...
                management_snmp_community_type_1_type_0 = (
                    ClusterCreateAttributeManagementSnmpCommunityType1Type0.from_dict(
                        data
                    )
                )
        ...
        def _parse_management_ipmi_credentials(
            ...
            try:
                ...
                management_ipmi_credentials_type_1_type_0 = (
                    ClusterCreateAttributeManagementIpmiCredentialsType1Type0.from_dict(
                        data
                    )
                )
        ...
        cluster_create_attribute.additional_properties = d
        return cluster_create_attribute
