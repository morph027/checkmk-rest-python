...
from ..models.create_host_group_downtime_downtime_type import (
    CreateHostGroupDowntimeDowntimeType,
)
from ..models.create_host_group_downtime_recur import CreateHostGroupDowntimeRecur
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateHostGroupDowntime")


@_attrs_define
class CreateHostGroupDowntime:
    """
    Attributes:
        ...
        downtime_type (CreateHostGroupDowntimeDowntimeType): The type of downtime to create.
             ...
             * `host_by_query` - Schedule downtimes for all host matching the query
             Example: host.
        hostgroup_name (str): The name of the host group. A downtime will be scheduled for all hosts in this host group.
            Example: windows.
        recur (CreateHostGroupDowntimeRecur | Unset): The recurring mode of the new downtime. Available modes are:     *
            ...
            * day_of_month  This only works when using the Enterprise Editions. Defaults to 'fixed'. Default:
            CreateHostGroupDowntimeRecur.FIXED. Example: hour.
    ...
    start_time: str
    end_time: str
    downtime_type: CreateHostGroupDowntimeDowntimeType
    hostgroup_name: str
    recur: CreateHostGroupDowntimeRecur | Unset = CreateHostGroupDowntimeRecur.FIXED
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        downtime_type = CreateHostGroupDowntimeDowntimeType(d.pop("downtime_type"))

        hostgroup_name = d.pop("hostgroup_name")

        _recur = d.pop("recur", UNSET)
        recur: CreateHostGroupDowntimeRecur | Unset
        if isinstance(_recur, Unset):
            recur = UNSET
        else:
            recur = CreateHostGroupDowntimeRecur(_recur)

        duration = d.pop("duration", UNSET)

        comment = d.pop("comment", UNSET)

        create_host_group_downtime = cls(
            start_time=start_time,
            end_time=end_time,
            downtime_type=downtime_type,
            hostgroup_name=hostgroup_name,
        ...
        create_host_group_downtime.additional_properties = d
        return create_host_group_downtime
