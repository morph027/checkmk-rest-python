...
from ..models.acknowledge_host_query_problem_acknowledge_type import (
...
T = TypeVar("T", bound="AcknowledgeHostQueryProblem")


@_attrs_define
class AcknowledgeHostQueryProblem:
    """
    Attributes:
        comment (str): Comment to be stored alongside the acknowledgement. Example: This was expected..
        acknowledge_type (AcknowledgeHostQueryProblemAcknowledgeType): Select hosts with a query. Example:
            host_by_query.
    ...
    comment: str
    acknowledge_type: AcknowledgeHostQueryProblemAcknowledgeType
    query: BinaryExpr | LogicalExpr | NotExpr
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acknowledge_host_query_problem = cls(
            comment=comment,
            acknowledge_type=acknowledge_type,
            query=query,
            sticky=sticky,
        ...
        acknowledge_host_query_problem.additional_properties = d
        return acknowledge_host_query_problem
