...
from ...models.create_service_downtime import CreateServiceDowntime
from ...models.create_service_group_downtime import CreateServiceGroupDowntime
from ...models.create_service_query_downtime import CreateServiceQueryDowntime
from ...types import Response


def _get_kwargs(
    *,
    body: CreateServiceDowntime
    ...
    if isinstance(body, CreateServiceDowntime):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, CreateServiceGroupDowntime):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (CreateServiceDowntime | CreateServiceGroupDowntime | CreateServiceQueryDowntime):
    ...
    Returns:
        Response[Any | Api400DefaultError | Api406DefaultError | Api415DefaultError | Api422DefaultError]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | Api400DefaultError | Api406DefaultError | Api415DefaultError | Api422DefaultError
    """
