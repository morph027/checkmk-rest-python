...
from ...models.create_host_downtime import CreateHostDowntime
from ...models.create_host_group_downtime import CreateHostGroupDowntime
from ...models.create_host_query_downtime import CreateHostQueryDowntime
from ...types import Response


def _get_kwargs(
    *,
    body: CreateHostDowntime | CreateHostGroupDowntime | CreateHostQueryDowntime,
    content_type: str,
) -> dict[str, Any]:
    ...
    if isinstance(body, CreateHostDowntime):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, CreateHostGroupDowntime):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
