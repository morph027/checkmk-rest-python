...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Api403DefaultError | Api404DefaultError | Api406DefaultError | BIRuleEndpoint | None
):
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Api403DefaultError | Api404DefaultError | Api406DefaultError | BIRuleEndpoint
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Api403DefaultError | Api404DefaultError | Api406DefaultError | BIRuleEndpoint]
    """
