...
from ...models.bi_aggregation_state_request import BIAggregationStateRequest
...
def _get_kwargs(
    *,
    body: BIAggregationStateRequest,
    content_type: str,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Api400DefaultError | Api406DefaultError | Api415DefaultError | BIAggregationStateResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        Api400DefaultError | Api406DefaultError | Api415DefaultError | BIAggregationStateResponse
    """
