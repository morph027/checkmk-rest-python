...
from ...models.bi_pack_endpoint import BIPackEndpoint
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/objects/bi_pack/{pack_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = BIPackEndpoint.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    in packs that you are a contact of.
       * `wato.bi_admin`: Edit all rules and aggregations for Business Intelligence, create, modify and
    delete rule packs.

    Args:
        pack_id (str):  Example: pack1.
    ...
    Returns:
        Response[Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError | Api415DefaultError | BIPackEndpoint]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError | Api415DefaultError | BIPackEndpoint
    """
