...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/objects/notification_rule/{rule_id}/actions/delete/invoke".format(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError | Api415DefaultError]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError | Api415DefaultError
    """
