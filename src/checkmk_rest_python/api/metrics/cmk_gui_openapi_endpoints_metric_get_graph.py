...
from ...models.get_graph import GetGraph
from ...models.get_metric import GetMetric
from ...models.graph_collection import GraphCollection
from ...types import Response


def _get_kwargs(
    *,
    body: GetGraph | GetMetric,
    content_type: str,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GraphCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Api400DefaultError | Api406DefaultError | Api415DefaultError | GraphCollection
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Api400DefaultError | Api406DefaultError | Api415DefaultError | GraphCollection]
    """
