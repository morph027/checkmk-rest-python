...
from ...models.bulk_input_service_group import BulkInputServiceGroup
from ...types import Response


def _get_kwargs(
    *,
    body: BulkInputServiceGroup,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/service_group_config/actions/bulk-create/invoke",
    }
