...
from ...models.bulk_update_service_group import BulkUpdateServiceGroup
from ...types import Response


def _get_kwargs(
    *,
    body: BulkUpdateServiceGroup,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/domain-types/service_group_config/actions/bulk-update/invoke",
    }
