...
from ...models.update_time_period import UpdateTimePeriod
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/objects/time_period/{name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Api400DefaultError | Api403DefaultError | Api404DefaultError | Api405DefaultError | Api406DefaultError | Api412DefaultError | Api415DefaultError | Api428DefaultError]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Api400DefaultError | Api403DefaultError | Api404DefaultError | Api405DefaultError | Api406DefaultError | Api412DefaultError | Api415DefaultError | Api428DefaultError
    """
