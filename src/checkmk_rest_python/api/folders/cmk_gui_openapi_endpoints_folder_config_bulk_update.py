...
from ...models.bulk_update_folder import BulkUpdateFolder
from ...types import Response


def _get_kwargs(
    *,
    body: BulkUpdateFolder,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/domain-types/folder_config/actions/bulk-update/invoke",
    }
