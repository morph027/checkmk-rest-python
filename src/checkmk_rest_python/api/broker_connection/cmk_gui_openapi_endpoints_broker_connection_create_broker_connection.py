...
from ...models.broker_connection_request_create import BrokerConnectionRequestCreate
from ...types import Response


def _get_kwargs(
    *,
    body: BrokerConnectionRequestCreate,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/broker_connection/collections/all",
    }
...
) -> Api400DefaultError | Api406DefaultError | Api415DefaultError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Api400DefaultError | Api406DefaultError | Api415DefaultError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Api400DefaultError | Api406DefaultError | Api415DefaultError
    """
