...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/audit_log/actions/archive/invoke",
    }
...
def sync_detailed(
    *,
    ...
    r"""Move audit log entries to archive
    ...
    all users with access to Setup.
       * `wato.clear_auditlog`: Archive the entries of the audit log. To be able to archive the audit
    log a user needs the generic Setup permission \"Make changes, perform actions\", the \"View audit
    log\" and this permission.
