...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/objects/password/{name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | Api400DefaultError | Api403DefaultError | Api404DefaultError | Api406DefaultError
    """
