...
from ...models.update_configuration_entity import UpdateConfigurationEntity
from ...types import Response


def _get_kwargs(
    *,
    body: UpdateConfigurationEntity,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/domain-types/configuration_entity/actions/edit-single-entity/invoke",
    }
