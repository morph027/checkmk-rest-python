...
from ...models.create_service_comment import CreateServiceComment
from ...models.create_service_query_comment import CreateServiceQueryComment
from ...types import Response


def _get_kwargs(
    *,
    body: CreateServiceComment | CreateServiceQueryComment,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/comment/collections/service",
    }

    if isinstance(body, CreateServiceComment):
