...
from ...models.create_host_comment import CreateHostComment
from ...models.create_host_query_comment import CreateHostQueryComment
from ...types import Response


def _get_kwargs(
    *,
    body: CreateHostComment | CreateHostQueryComment,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/comment/collections/host",
    }

    if isinstance(body, CreateHostComment):
