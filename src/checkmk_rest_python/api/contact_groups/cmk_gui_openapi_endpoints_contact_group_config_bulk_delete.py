...
from ...models.bulk_delete_contact_group import BulkDeleteContactGroup
from ...types import Response


def _get_kwargs(
    *,
    body: BulkDeleteContactGroup,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/contact_group_config/actions/bulk-delete/invoke",
    }
