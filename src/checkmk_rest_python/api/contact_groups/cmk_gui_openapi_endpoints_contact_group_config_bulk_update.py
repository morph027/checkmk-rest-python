...
from ...models.bulk_update_contact_group import BulkUpdateContactGroup
from ...types import Response


def _get_kwargs(
    *,
    body: BulkUpdateContactGroup,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/domain-types/contact_group_config/actions/bulk-update/invoke",
    }
