...
from ...models.move_to_folder import MoveToFolder
from ...models.move_to_specific_rule import MoveToSpecificRule
...
def _get_kwargs(
    rule_id: str,
    *,
    body: MoveToFolder | MoveToSpecificRule,
    if_match: str,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/objects/rule/{rule_id}/actions/move/invoke".format(
            rule_id=quote(str(rule_id), safe=""),
        ),
    }

    if isinstance(body, MoveToFolder):
