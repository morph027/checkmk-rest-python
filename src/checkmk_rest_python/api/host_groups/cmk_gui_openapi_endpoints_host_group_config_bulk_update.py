...
from ...models.bulk_update_host_group import BulkUpdateHostGroup
from ...types import Response


def _get_kwargs(
    *,
    body: BulkUpdateHostGroup,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/domain-types/host_group_config/actions/bulk-update/invoke",
    }
