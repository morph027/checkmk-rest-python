...
from ...models.api_404_custom_error_4 import Api404CustomError4
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/objects/service_discovery_run/{host_name}/actions/wait-for-completion/invoke".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | Api403DefaultError | Api404CustomError4 | Api406DefaultError | None:
    ...
    if response.status_code == 404:
        response_404 = Api404CustomError4.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | Api403DefaultError | Api404CustomError4 | Api406DefaultError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | Api403DefaultError | Api404CustomError4 | Api406DefaultError
    """
