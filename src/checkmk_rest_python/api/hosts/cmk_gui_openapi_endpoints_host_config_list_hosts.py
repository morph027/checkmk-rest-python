...
def _get_kwargs(
    *,
    ...
    include_links: bool | Unset = False,
    ...
    json_hostnames: list[str] | Unset = UNSET
    if not isinstance(hostnames, Unset):
        json_hostnames = hostnames

    params["hostnames"] = json_hostnames
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        include_links (bool | Unset):  Default: False.
        fields (str | Unset):  Example: !(links).
        hostnames (list[str] | Unset):  Example: ['host1', 'host2'].
        site (str | Unset):  Example: site1.
