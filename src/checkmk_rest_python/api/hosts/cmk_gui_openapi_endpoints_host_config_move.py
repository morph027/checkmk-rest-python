...
from ...models.move_host import MoveHost
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/objects/host_config/{host_name}/actions/move/invoke".format(
...
def sync_detailed(
    ...
    *,
    ...
    services (inventory) there is a separate permission (see below)
       * `wato.move_hosts`: Move existing hosts to other folders. Please also add the permission
