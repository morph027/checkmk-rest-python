...
from ...models.create_cluster_host import CreateClusterHost
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: CreateClusterHost,
...
def sync_detailed(
    *,
    ...
    All the services of the individual nodes will be collated on the cluster host.This endpoint requires
