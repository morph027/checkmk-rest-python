...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/objects/quick_setup_action_result/{job_id}".format(
...
) -> Api404DefaultError | Api406DefaultError | QuickSetupCompleteResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Api404DefaultError | Api406DefaultError | QuickSetupCompleteResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Api404DefaultError | Api406DefaultError | QuickSetupCompleteResponse
    """
