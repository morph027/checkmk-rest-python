...
from ...models.filter_by_id import FilterById
from ...models.filter_by_params import FilterByParams
from ...models.filter_by_query import FilterByQuery
from ...types import Response


def _get_kwargs(
    *,
    body: FilterById | FilterByParams | FilterByQuery,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/event_console/actions/delete/invoke",
    }

    if isinstance(body, FilterById):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, FilterByQuery):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
