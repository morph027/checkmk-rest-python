...
from ...models.update_and_acknowlede_event_site_id_required import (
...
def _get_kwargs(
    event_id: str,
    *,
    body: UpdateAndAcknowledeEventSiteIDRequired,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/objects/event_console/{event_id}/actions/update_and_acknowledge/invoke".format(
