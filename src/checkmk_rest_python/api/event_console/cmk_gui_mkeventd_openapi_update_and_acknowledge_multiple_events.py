...
from ...models.update_and_acknowledge_filter import UpdateAndAcknowledgeFilter
from ...models.update_and_acknowledge_with_params import UpdateAndAcknowledgeWithParams
from ...models.update_and_acknowledge_with_query import UpdateAndAcknowledgeWithQuery
from ...types import Response


def _get_kwargs(
    *,
    body: UpdateAndAcknowledgeFilter
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/event_console/actions/update_and_acknowledge/invoke",
    }

    if isinstance(body, UpdateAndAcknowledgeWithQuery):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, UpdateAndAcknowledgeWithParams):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (UpdateAndAcknowledgeFilter | UpdateAndAcknowledgeWithParams |
            UpdateAndAcknowledgeWithQuery):
