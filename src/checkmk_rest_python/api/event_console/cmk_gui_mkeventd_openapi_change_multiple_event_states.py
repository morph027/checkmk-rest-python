...
from ...models.change_state_with_params import ChangeStateWithParams
from ...models.change_state_with_query import ChangeStateWithQuery
from ...types import Response


def _get_kwargs(
    *,
    body: ChangeStateWithParams | ChangeStateWithQuery,
    content_type: str,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/domain-types/event_console/actions/change_state/invoke",
    }

    if isinstance(body, ChangeStateWithQuery):
